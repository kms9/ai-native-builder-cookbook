...
本文件是 [实践案例｜从多维表需求到 MR 与上线](案例A-从多维表需求到MR与上线.md) 的章节化阅读入口。案例基于内部实践，经过去标识化和教学重构；后文统一简称“实践案例”。
...
相关正文：[第 6A 章｜从 SOP 到智能体约束](06A-从SOP到智能体约束.md)
...
选择一条已经处理过的需求，填写 [SOP 到智能体约束转化卡](模板-SOP到智能体约束转化卡.md)。如果约束只能写成“Agent 自行判断”，或异常没有接收人和恢复条件，就不要把它交给第 7 章做系统契约。
