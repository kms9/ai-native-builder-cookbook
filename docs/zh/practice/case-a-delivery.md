---
title: "实践案例｜从多维表需求到 MR 与上线"
desc: "基于内部 Skill 仓库交付实践进行脱敏和教学重构的案例，展示需求分析、代码生成、MR、测试、发布及复杂需求分流。"
aliases:
  - "Skill仓库自动交付案例"
  - "从需求到MR与上线"
  - "内部实践交付闭环"
...
| 本书章节 | 本案例展示的问题 |
|---|---|
| [第 5 章](../chapters/05-verifiable-scenario.md) | 为什么“做知识库”“增加 Package”还不是可实施场景 |
| [第 6 章](../chapters/06-workflow-redesign.md) | 业务入口不迁移时，人、AI 和系统怎样重新分工 |
| [第 7 章](../chapters/07-runnable-system.md) | 需求怎样进入任务契约、状态机、工具和 checkpoint |
| [第 8 章](../chapters/08-evaluation-and-governance.md) | 为什么 AI Review 不能替代独立检查和环境结果 |
| [第 9 章](../chapters/09-pilot-to-adoption.md) | 运行时间、登录和提交数量为何不能直接证明净价值 |
| [第 10 章](../chapters/10-organizational-capability.md) | 单一维护者、Owner、版本和第二团队复用怎样决定资产化 |
| [配套实践旁注](./delivery-notes.md) | 按第 5—10 章组织本案例的教学插入点 |
| [练习册扩展](./delivery-workbook.md) | 将经验转成可直接填写的分流、状态、质量检查和指标模板 |
