...
然后完成一份问题一页纸，并决定这个问题是否值得进入流程设计。你可以直接使用练习册中的[场景机会池](../practice/workbook.md#场景机会池)、[证据日志](../practice/workbook.md#证据日志)和[问题一页纸](../practice/workbook.md#问题一页纸与是否继续的决定)：机会池用于比较，证据日志用于区分事实与假设，一页纸负责把决定交给下一阶段。
...
[下一章：重构人—AI—系统工作流](./06-workflow-redesign.md)
