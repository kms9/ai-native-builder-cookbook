...
最后写一份决定报告。扩大、迭代、缩小、继续影子、暂停或终止都可以，决定必须引用证据、限制、负责人和下一复审日期。你可以使用练习册中的[试点计划](../practice/workbook.md#试点计划)和[试点结果与后续决定](../practice/workbook.md#试点结果与后续决定)。
...
[下一章：把一次项目变成组织能力](./10-organizational-capability.md)
