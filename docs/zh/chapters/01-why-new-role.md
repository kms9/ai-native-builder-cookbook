...
desc: "从一次看似成功的 AI 演示出发，解释模型输出与业务结果之间的建设链、五类责任断层，以及企业内部为什么需要 AI Native Builder。"
aliases:
  - "企业AI角色空缺"
  - "为什么需要AI原生建设者"
tags:
...
> [!example] 教学案例
> 本章中的澄川工业及相关人物、数据均为教学设定，只用于展示项目判断。
...
这两份资料来自不同的组织安排，却指向相似的外部交付现实：当供应方把 AI 带进客户的重要流程，模型能力、客户现场、系统交付、采用和反馈很难由彼此隔离的团队依次转交。
