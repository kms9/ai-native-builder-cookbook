...
这五档与[术语表](../reference/glossary.md#逐动作决定-ai-可以做什么)使用同一套名称。让 AI 准备内容、由人确认后执行，不一定比让 AI 连续执行多步动作差。若动作不可逆、涉及对外承诺或错误难以及时发现，让人确认可能是更合适的设计。只有在净收益增加、失败可观察、权限可限制且恢复可行时，才值得增加 AI 的动作权限。
