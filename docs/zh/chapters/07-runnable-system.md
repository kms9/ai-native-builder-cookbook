...
继续使用上一章决定建设的场景。你可以直接填写练习册中的[上下文地图](../practice/workbook.md#上下文地图)、[业务对象卡](../practice/workbook.md#业务对象卡)、[工具契约](../practice/workbook.md#工具契约)和[运行轨迹](../practice/workbook.md#运行轨迹与是否进入系统评估的决定)，也可以在自己的项目文档中完成同等内容。若没有真实授权材料，请标明“教学模拟”。
...
[下一章：用评估与治理证明系统可控](./08-evaluation-and-governance.md)
