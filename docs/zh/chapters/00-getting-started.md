...
开始前，为八类能力做一次 0—2 分自评：0 表示从未做过，1 表示在指导下完成过，2 表示能够独立完成并出示证据。完整表格在练习册的[能力前测](../practice/workbook.md#能力前测)中，可以复制到自己的项目目录。这八类对应全书主线：问题发现、工作流重构、业务约束、系统契约、评估、治理、试点采用，以及复用与诚实披露。结业时改用五维 0—4 分画像；前测只用来安排时间。
