...
开始前，为八类能力做一次 0—2 分自评：0 表示从未做过，1 表示在指导下完成过，2 表示能够独立完成并出示证据。完整表格在练习册的[学习契约](../practice/workbook.md#学习契约)中，可以复制到自己的项目目录。
...
继续阅读：[第 1 章：为什么企业 AI 需要新的建设角色](./01-why-new-role.md)。
