...
你可以直接使用练习册中的[现状流程记录](../practice/workbook.md#现状流程记录)、[目标流程与责任矩阵](../practice/workbook.md#目标流程与责任矩阵)和[五分钟原型](../practice/workbook.md#五分钟原型与是否建设的决定)。前者保留现状证据，中间一项连接目标步骤与责任，最后一项记录演示材料和反馈。表格填完后，还要写下是否继续建设及其证据边界。
...
[下一章：从 SOP 到智能体约束](./06a-sop-to-agent-constraints.md)
